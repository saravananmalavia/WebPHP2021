...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 09:57 PM
...
(341, 'PHP', '2021-04-03', '15:50:00.000000', 'good'),
...
(235, 'ajith', 'street 2 kollam', 'male', 'aji@gmail.com', 8767656543, 'UG', 'PHP'),
...
--
ALTER TABLE `tbl_exam_timetable`
  MODIFY `exam_time_table_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=346;

--
-- AUTO_INCREMENT for table `tbl_staff_details`
--
ALTER TABLE `tbl_staff_details`
  MODIFY `staff_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=242;
COMMIT;
